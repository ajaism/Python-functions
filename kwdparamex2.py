#kwdparamex2.py
def dispstudinfo (ename,eno,marks,crs,cnt="INDIA"):
      print("{}\t{}\t{}\t{}\t{}".format(eno,ename,marks,crs,cnt))
...
dispstudinfo(cnt="USA",eno=104,crs="Politics",marks=00.00,ename="Trump")
dispstudinfo("Jobiden",cnt="USA",eno=105,crs="Politics",marks=00.00)